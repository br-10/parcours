...
<Heading variant="titel"> Hosting und E-Mail-Versand</Heading>
<Text variant="solid">
...
<Heading variant="titel"> Google Tag Manager</Heading>
<Text variant="solid">
...
<Heading variant="titel"> Google Analytics</Heading>
<Text variant="solid">
...
Weitere Informationen zur Datennutzung durch Google, Einstellungs- und Widerspruchsmöglichkeiten, erfahren Sie in der Datenschutzerklärung von Google (<a href="https://policies.google.com/privacy">Googles Datenschutz</a>) sowie in den Einstellungen für die Darstellung von Werbeeinblendungen durch Google (<a href="https://adssettings.google.com/authenticated">Google Werbeeinblendungen)</a>).

Die personenbezogenen Daten der Nutzer werden nach 14 Monaten gelöscht oder anonymisiert.

</Text>

<Heading variant="titel"> Onlinepräsenzen in sozialen Medien</Heading>
<Text variant="solid">
...
weisen wir darauf hin, dass sie sich damit verpflichten, die Datenschutzstandards der EU einzuhalten.
...
auf Grundlage einer Vereinbarung über gemeinsame Verarbeitung personenbezogener Daten:
...
<Heading variant="titel"> Einbindung von Diensten und Inhalten Dritter</Heading>
<Text variant="solid">
...
<Heading variant="titel"> Vimeo</Heading>
<Text variant="solid">
Wir können die Videos der Plattform “Vimeo” des Anbieters Vimeo Inc., Attention: Legal Department, 
555 West 18th Street New York, New York 10011, USA, einbinden.
...
<Heading variant="titel"> Youtube</Heading>
<Text variant="solid">
...
<Heading variant="titel"> Google Fonts</Heading>
<Text variant="solid">
...
<Heading variant="titel"> Google Maps</Heading>
<Text variant="solid">
...
<Heading variant="titel"> Verwendung von Facebook Social Plugins</Heading>
<Text variant="solid">
...
<a href="https://www.privacyshield.gov/participant?id=a2zt0000000GnywAAC&status=Active">Abkommmen s.o.</a>
...
die Nutzer daher entsprechend unserem Kenntnisstand.
...
Zweck und Umfang der Datenerhebung und die weitere Verarbeitung und Nutzung der Daten durch Facebook
 ...
 <a href="https://www.facebook.com/about/privacy/">Opt-Out </a>
...
Dennoch ist das Auftreten von Fehlern nicht völlig auszuschließen. Das Theater Willy Praml übernimmt keine Haftung für die Aktualität, die inhaltliche Richtigkeit sowie für die Vollständigkeit der in seinem Webangebot eingestellten Informationen, es sei denn die Fehler wurden vorsätzlich oder grob fahrlässig aufgenommen. Dies bezieht sich auf eventuelle Schäden materieller oder ideeller Art Dritter, die durch die Nutzung dieses Webangebotes verursacht wurden.
...
*Alle oben gelisteten Datenschutzerklärungen wurden erstellt mit dem Datenschutz-Generator.de von RA Dr. jur. Thomas Schwenke* 

</Text>
<Heading variant="titel"> Rechtswirksamkeit</Heading>
<Text variant="solid">
Dieser Haftungsausschluss ist Teil unseres Internetangebotes, Bacharach. 
Sofern einzelne Formulierungen oder Teile dieses Textes der geltenden Rechtslage nicht
 mehr oder nicht mehr vollständig entsprechen, bleiben die übrigen Teile dieser Erklärung davon unberührt.
 </Text>

<Heading variant="titel"> Copyright</Heading>
<Text variant="solid">
Das Layout der Homepage, die verwendeten Grafiken und Bilder sowie die einzelnen Beiträge sind urheberrechtlich geschützt.
</Text>
<Heading variant="titel"> Externe Verweise und Links</Heading>
<Text variant="solid">
Wir haben keinen Einfluss auf Gestaltung und Inhalte fremder Internetseiten. 
Wir distanzieren uns daher von allen fremden Inhalten, auch wenn von der Webseite von Markt 1
...
<Heading variant="titel"> Fotos</Heading>
<Text variant="solid">
Die auf der Website von uns verwendeten Fotos unterliegen dem Copyright des jeweiligen Fotografen/Künstlers. 
Wir bemühen uns immer um korrekte Quellenangaben.
</Text>
<Heading variant="titel"> Video-Trailer</Heading>
<Text variant="solid">
Die auf der Website von uns verwendeten Videos/Trailer unterliegen dem Copyright des jeweiligen Künstlers, 
...
ebenfalls für Verlinkungen auf unsere Webseite.
</Text>
</Box>

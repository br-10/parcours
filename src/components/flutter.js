      ...
      <div>
        {trail.map(({ x, height, ...rest }, index) => (
          <a.div
            ...
            <a.div key={index} ><span style={{color:"red"}}>{items[index]}</span></a.div>
          </a.div>
        ))}
      </div>
    </div>
...
function Flutter() {
  ...
  return (
    ...
    <Box  p="0" m="0" width="100%"><Link to="/rotes-fenster"><Text fontWeight="500" p="0" m="0" fontSize={[18,23,40]} >Rotes Fenster Wernerkapelle</Text></Link></Box>  
       ...
       <Box p="0" m="0" width="100%"><Link color="blue" style={{color:"red"}} to="/"><Text fontWeight="500" fontWeight="500" p="0" m="0" fontSize={[18,23,40]}>Propaganda der NS-Zeit</Text></Link></Box>
      <Box p="0" m="0" width="100%"><Link to="galerie"><Text fontWeight="500" p="0" m="0" fontSize={[18,23,40]}>Jüdische Bürger vor 1933</Text></Link></Box>
      ...
      <Box p="0" m="0" width="100%"><Link to="/p1"><Text fontWeight="500" p="0" m="0" fontSize={[18,23,40]}>Friedhöfe</Text></Link></Box>
      <Box p="0" m="0" width="100%"><Link to="/p3"><Text fontWeight="500" p="0" m="0" fontSize={[18,23,40]}>Emigration</Text></Link></Box>
